...
namespace NRKernal.NRExamples
{
    ...
    public class AppManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// FOr tracking long press of app button.
        /// 0 means recenter is triggered, or app button is up.  
        /// /// /// </summary>
        private float m_AppPressTimer = 0f;
        ...
        private void OnEnable()
        {
            ...
            // TO detect long press and recenter controller.
            NRInput.AddPressingListener(ControllerHandEnum.Right, ControllerButton.APP, OnAppButtonPressing);
            NRInput.AddPressingListener(ControllerHandEnum.Left, ControllerButton.APP, OnAppButtonPressing);
            NRInput.AddUpListener(ControllerHandEnum.Right, ControllerButton.APP, OnAppButtonUp);
            NRInput.AddUpListener(ControllerHandEnum.Left, ControllerButton.APP, OnAppButtonUp);
            NRInput.AddDownListener(ControllerHandEnum.Right, ControllerButton.APP, OnAppButtonDown);
            NRInput.AddDownListener(ControllerHandEnum.Left, ControllerButton.APP, OnAppButtonDown);
        ...
        private void OnDisable()
        {
            ...
            NRInput.RemovePressingListener(ControllerHandEnum.Right, ControllerButton.APP, OnAppButtonPressing);
            NRInput.RemovePressingListener(ControllerHandEnum.Left, ControllerButton.APP, OnAppButtonPressing);
            NRInput.RemoveUpListener(ControllerHandEnum.Right, ControllerButton.APP, OnAppButtonUp);
            NRInput.RemoveUpListener(ControllerHandEnum.Left, ControllerButton.APP, OnAppButtonUp);
            NRInput.RemoveDownListener(ControllerHandEnum.Right, ControllerButton.APP, OnAppButtonDown);
            NRInput.RemoveDownListener(ControllerHandEnum.Left, ControllerButton.APP, OnAppButtonDown);
        ...
        private void OnAppButtonPressing()
        {
            if (m_AppPressTimer > 0)
            {
                if (Time.unscaledTime - m_AppPressTimer > 1.0f)
                {
                    // Reset Controller.  
        ...
        private void OnAppButtonUp()
        {
            // Switch casting mode, if recenter is not triggered. 
            if (m_AppPressTimer != 0)
            {
        ...
        private void OnAppButtonDown()
        {
            m_AppPressTimer = Time.unscaledTime;
        }
